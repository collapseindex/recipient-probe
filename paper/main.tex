...
Figure~\ref{fig:specificity}). The effect requires the specific learned direction, not a perturbation of
matched norm.

\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{specificity.pdf}
...
(Figure~\ref{fig:localize}, Table~\ref{tab:localize}).
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{localization.pdf}
...
diffuse for Llama-8B). The gap between the blue and red onsets is the discard: the intent is represented
before it is routed into the readout. $n{=}60$.}
\label{fig:localize}
\end{figure*}
