...
app = modal.App("recipient-probe-70b")
...
@app.function(image=image, gpu="H100:2", volumes={"/root/.cache/huggingface": cache},
...
def main():
    ...
    with open("sweep_70b.json", "w", encoding="utf-8") as f:
        json.dump(out, f, indent=1)
    print("WROTE sweep_70b.json")
